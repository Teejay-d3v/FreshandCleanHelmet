  ...
  <div class="bg-gradient-to-r from-blue-300 to-teal-100 pt-32 pb-10">
    ...
    <section class="">
      <div class="container mx-auto flex flex-col md:flex-row items-center rounded-3xl bg-white mb-20 shadow-2xl">
        ...
        <div ref="paragraph1" class="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left p-4 pl-10">
          <h2 class="text-5xl font-semibold text-indigo-600 py-2">Deep-Clean Technology</h2>
    ...
    <section class="">
      <div class="container mx-auto flex flex-col md:flex-row-reverse items-center rounded-3xl bg-white mb-20 shadow-2xl">
        ...
        <div ref="paragraph2" class="px-10 w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left p-4 pr-10">
          <h2 class="text-5xl font-semibold text-indigo-600 py-2">Turbo-Dry System</h2>
          <p class="text-gray-700 text-lg leading-relaxed ">
    ...
    <section class="">
      <div class="container mx-auto flex flex-col md:flex-row items-center rounded-3xl bg-white mb-20 shadow-2xl">
        ...
        <div ref="paragraph3" class="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left p-4 pl-10">
          <h2 class="text-5xl font-semibold text-indigo-600 py-2">Bacteria-Busting Power</h2>
          <p class="text-gray-700 text-lg leading-relaxed">
