          ...
          <div class="lg:w-1/2 w-full mb-5 lg:mb-0   ">
            ...
            <div class="flex flex-col flex-wrap lg:py-6 rounded-r-3xl lg:w-1/2 lg:pl-12 lg:text-left p-5 lg:p-0 bg-white">
                <div class="flex flex-col mb-5 items-start">
                    ...
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font mb-3 font-semibold">Dry Cleaning</h2>
                ...
                <div class="flex flex-col mb-4 items-start">
                    ...
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font mb-3 font-semibold">Disinfection and Sterilization</h2>
                ...
                <div class="flex flex-col mb-4 items-start">
                    ...
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font mb-3 font-semibold">Deodorization</h2>
