  ...
  <div class="bg-gradient-to-r from-blue-300 to-teal-100 py-10">
          ...
          <div class="lg:w-1/2 w-full mb-5 lg:mb-0   ">
            ...
            <div class="flex flex-col flex-wrap lg:py-6 rounded-r-3xl lg:w-1/2 lg:pl-12 lg:text-left text-center bg-white">
                <div class="flex flex-col mb-5 items-start">
                    ...
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Dry Cleaning</h2>
                        <p class="leading-relaxed text-base">Utilizes advanced dry cleaning technology to effectively remove dirt and grime without using water, ensuring helmets are clean and safe for use.</p>
                    </div>
                </div>
                <div class="flex flex-col mb-4 items-start">
                    <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M96 32l0 96 128 0 0-96c0-17.7-14.3-32-32-32L128 0C110.3 0 96 14.3 96 32zm0 128c-53 0-96 43-96 96L0 464c0 26.5 21.5 48 48 48l224 0c26.5 0 48-21.5 48-48l0-208c0-53-43-96-96-96L96 160zm64 96a80 80 0 1 1 0 160 80 80 0 1 1 0-160zM384 48c0-1.4-1-3-2.2-3.6L352 32 339.6 2.2C339 1 337.4 0 336 0s-3 1-3.6 2.2L320 32 290.2 44.4C289 45 288 46.6 288 48c0 1.4 1 3 2.2 3.6L320 64l12.4 29.8C333 95 334.6 96 336 96s3-1 3.6-2.2L352 64l29.8-12.4C383 51 384 49.4 384 48zm76.4 45.8C461 95 462.6 96 464 96s3-1 3.6-2.2L480 64l29.8-12.4C511 51 512 49.4 512 48c0-1.4-1-3-2.2-3.6L480 32 467.6 2.2C467 1 465.4 0 464 0s-3 1-3.6 2.2L448 32 418.2 44.4C417 45 416 46.6 416 48c0 1.4 1 3 2.2 3.6L448 64l12.4 29.8zm7.2 100.4c-.6-1.2-2.2-2.2-3.6-2.2s-3 1-3.6 2.2L448 224l-29.8 12.4c-1.2 .6-2.2 2.2-2.2 3.6c0 1.4 1 3 2.2 3.6L448 256l12.4 29.8c.6 1.2 2.2 2.2 3.6 2.2s3-1 3.6-2.2L480 256l29.8-12.4c1.2-.6 2.2-2.2 2.2-3.6c0-1.4-1-3-2.2-3.6L480 224l-12.4-29.8zM448 144c0-1.4-1-3-2.2-3.6L416 128 403.6 98.2C403 97 401.4 96 400 96s-3 1-3.6 2.2L384 128l-29.8 12.4c-1.2 .6-2.2 2.2-2.2 3.6c0 1.4 1 3 2.2 3.6L384 160l12.4 29.8c.6 1.2 2.2 2.2 3.6 2.2s3-1 3.6-2.2L416 160l29.8-12.4c1.2-.6 2.2-2.2 2.2-3.6z"/></svg>
                    </div>
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Disinfection and Sterilization</h2>
                        <p class="leading-relaxed text-base">Employs UV-C light technology to disinfect helmets, effectively killing harmful bacteria and viruses for enhanced hygiene.</p>
                    </div>
                </div>
                <div class="flex flex-col mb-4 items-start">
                    <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M128 0l64 0c17.7 0 32 14.3 32 32l0 96L96 128l0-96c0-17.7 14.3-32 32-32zM0 256c0-53 43-96 96-96l128 0c53 0 96 43 96 96l0 208c0 26.5-21.5 48-48 48L48 512c-26.5 0-48-21.5-48-48L0 256zm240 80A80 80 0 1 0 80 336a80 80 0 1 0 160 0zM256 64a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zM384 32a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm64 32a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zm32 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM448 256a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zM384 128a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg>
                    </div>
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Deodorization</h2>
                        <p class="leading-relaxed text-base">Uses an innovative deodorizing process to eliminate odors, leaving helmets smelling fresh and clean.</p>
                    </div>
                </div>
                <div class="flex flex-col mb-4 items-start">
                    <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 500"><path d="M128 112c0-26.5 21.5-48 48-48s48 21.5 48 48l0 164.5c0 17.3 7.1 31.9 15.3 42.5C249.8 332.6 256 349.5 256 368c0 44.2-35.8 80-80 80s-80-35.8-80-80c0-18.5 6.2-35.4 16.7-48.9c8.2-10.6 15.3-25.2 15.3-42.5L128 112zM176 0C114.1 0 64 50.1 64 112l0 164.4c0 .1-.1 .3-.2 .6c-.2 .6-.8 1.6-1.7 2.8C43.2 304.2 32 334.8 32 368c0 79.5 64.5 144 144 144s144-64.5 144-144c0-33.2-11.2-63.8-30.1-88.1c-.9-1.2-1.5-2.2-1.7-2.8c-.1-.3-.2-.5-.2-.6L288 112C288 50.1 237.9 0 176 0zm0 416c26.5 0 48-21.5 48-48c0-20.9-13.4-38.7-32-45.3L192 112c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 210.7c-18.6 6.6-32 24.4-32 45.3c0 26.5 21.5 48 48 48zM480 160l32 0c12.9 0 24.6-7.8 29.6-19.8s2.2-25.7-6.9-34.9l-64-64c-12.5-12.5-32.8-12.5-45.3 0l-64 64c-9.2 9.2-11.9 22.9-6.9 34.9s16.6 19.8 29.6 19.8l32 0 0 288c0 17.7 14.3 32 32 32s32-14.3 32-32l0-288z"/></svg>
                    </div>
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Tumble Dry on High Heat</h2>
                        <p class="leading-relaxed text-base">Features a tumble-dry mechanism that safely dries helmets on high heat, ensuring they're ready for immediate use.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <section class="text-gray-600 body-font">
        <div class="container lg:px-5 pb-10 mx-auto flex flex-wrap">
            ...
            <div class="flex flex-col mb-5 items-start ">
              ...
              <div class="flex flex-col mb-5 items-start ">
                <div class=" rounded flex h-full items-center">
                  ...
                  <h2 class="text-gray-900 text-lg title-font font-medium ">Weight: 105kg</h2>
                </div>
                <div class="flex-grow">
                  <p class="leading-relaxed text-slate-400 text-sm">Built with sturdy materials, the machine weighs 105kg, ensuring stability during operation.</p>
                </div>
              </div>
              ...
              <div class="flex flex-col mb-5 items-start ">
                <div class=" rounded flex h-full items-center">
                  ...
                  <h2 class="text-gray-900 text-lg title-font font-medium ">Height: 1720mm</h2>
                </div>
                <div class="flex-grow">
                  <p class="leading-relaxed text-slate-400 text-sm">A towering 1720mm height for optimal user interaction and ease of use.</p>
                </div>
              </div>
              ...
              <div class="flex flex-col mb-5 items-start ">
                <div class=" rounded flex h-full items-center">
                  ...
                  <h2 class="text-gray-900 text-lg title-font font-medium "> Width: 560mm</h2>
                </div>
                <div class="flex-grow">
                  <p class="leading-relaxed text-slate-400 text-sm">A width of 560mm, allowing for a compact yet functional design.</p>
                </div>
              </div>
              ...
              <div class="flex flex-col mb-5 items-start ">
                <div class=" rounded flex h-full items-center">
                  ...
                  <h2 class="text-gray-900 text-lg title-font font-medium ">Length: 560mm</h2>
                </div>
                <div class="flex-grow">
                  <p class="leading-relaxed text-slate-400 text-sm">Streamlined with a length of 560mm, fitting seamlessly into various spaces.</p>
                </div>
              </div>
              ...
              <div class="flex flex-col mb-5 items-start ">
                <div class=" rounded flex h-full items-center">
                  ...
                  <h2 class="text-gray-900 text-lg title-font font-medium ">HD Touch All-In-One</h2>
                </div>
                <div class="flex-grow">
                  <p class="leading-relaxed text-slate-400 text-sm">Features an HD touch display for smooth, intuitive interaction.</p>
                </div>
              </div>
              ...
              <div class="flex flex-col mb-5 items-start ">
                <div class=" rounded flex h-full items-center">
                  ...
                  <h2 class="text-gray-900 text-lg title-font font-medium ">Breathe Ambient Lighting</h2>
                </div>
                <div class="flex-grow">
                  <p class="leading-relaxed text-slate-400 text-sm">Elegant ambient lighting for an enhanced visual experience and user comfort.</p>
                </div>
              </div>
              ...
              <div class="flex flex-col mb-5 items-start ">
                <div class=" rounded flex h-full items-center">
                  ...
                  <h2 class="text-gray-900 text-lg title-font font-medium ">Helmet Washing Area</h2>
                </div>
                <div class="flex-grow">
                  <p class="leading-relaxed text-slate-400 text-sm">Dedicated area for washing helmets, providing convenience and hygiene.</p>
                </div>
              </div>
              ...
              <div class="flex flex-col mb-5 items-start ">
                <div class=" rounded flex h-full items-center">
                  ...
                  <h2 class="text-gray-900 text-lg title-font font-medium "> Coin Ware</h2>
                </div>
                <div class="flex-grow">
                  <p class="leading-relaxed text-slate-400 text-sm">Equipped with a coin ware for easy, cash-based transactions.</p>
                </div>
              </div>
          ...
          <div class="hidden lg:block lg:w-1/2 w-full mb-5 lg:mb-0   ">
