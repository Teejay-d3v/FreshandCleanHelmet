      ...
      <div class="container mx-auto px-5">
        <div class="lg:w-4/5 mx-auto flex flex-wrap bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div class="lg:w-2/4 w-full flex flex-col items-center justify-center p-8 bg-gray-50">
            <div id="main-slider" class="splide w-full rounded-lg shadow-md overflow-hidden">
              <div class="splide__track">
                <ul class="splide__list">
                  <li v-for="image in images" :key="image" class="splide__slide">
                    <img :src="image" ref="image1" alt="Helmet Clean and Fresh Machine" class="w-full h-auto object-cover object-center rounded-lg transition-transform duration-500 hover:scale-105" />
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="lg:w-2/4 w-full p-10 bg-white">
            <!-- Product Title -->
